...
import { getFullnodeUrl, SuiClient } from '@/vendor/sui/client';
import {
  Transaction,
  TransactionArgument,
  TransactionObjectArgument,
  TransactionResult,
} from '@/vendor/sui/transactions';
import { normalizeStructTag, parseStructTag } from '@/vendor/sui/utils';
...
import { Field } from '@/_generated/bucket_v2_saving_incentive/deps/aptos/dynamic_field.js';
...
export class BucketClient {
  ...
  /**
   * @description Alias getter for Aptos-style naming while we migrate.
   * Returns the underlying SuiClient instance for now (non-destructive).
   */
  getAptosClient(): SuiClient {
    return this.suiClient;
  }
