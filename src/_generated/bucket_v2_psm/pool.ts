...
import * as balance_1 from './deps/aptos/balance.js';
...
export const Pool = new MoveStruct({ name: `${$moduleName}::Pool`, fields: {
        id: object.UID,
        decimal: bcs.u8(),
...
export interface SetPriceToleranceOptions {
    package?: string;
    arguments: SetPriceToleranceArguments | [
        pool: RawTransactionArgument<string>,
        Cap: RawTransactionArgument<string>,
        toleranceBps: RawTransactionArgument<number | bigint>
    ];
...
export interface ConversionRateOptions {
    package?: string;
    arguments: ConversionRateArguments | [
        pool: RawTransactionArgument<string>
    ];
    typeArguments: [
        string
...
export interface SwapInFeeRateOptions {
    package?: string;
    arguments: SwapInFeeRateArguments | [
        pool: RawTransactionArgument<string>,
        partner: RawTransactionArgument<string | null>
    ];
    typeArguments: [
...
export interface SwapOutFeeRateOptions {
    package?: string;
    arguments: SwapOutFeeRateArguments | [
        pool: RawTransactionArgument<string>,
        partner: RawTransactionArgument<string | null>
    ];
    typeArguments: [
...
export interface PriceToleranceOptions {
    package?: string;
    arguments: PriceToleranceArguments | [
        pool: RawTransactionArgument<string>
    ];
    typeArguments: [
        string
