...
import { bcs } from '@/vendor/sui/bcs';
import { type Transaction } from '@/vendor/sui/transactions';
...
import * as balance from './deps/aptos/balance.js';
import * as object from './deps/aptos/object.js';
import * as table from './deps/aptos/table.js';
import * as vec_map from './deps/aptos/vec_map.js';
import * as vec_set from './deps/aptos/vec_set.js';

const $moduleName = '@local-pkg/bucket_saving_incentive::saving_incentive';
export const SavingPoolIncentives = new MoveStruct({
  name: `${$moduleName}::SavingPoolIncentives`,
  fields: {
...
export const RewardManager = new MoveStruct({
  name: `${$moduleName}::RewardManager`,
  fields: {
    id: object.UID,
...
export const StakeData = new MoveStruct({
  name: `${$moduleName}::StakeData`,
  fields: {
...
export const RewarderKey = new MoveStruct({
  name: `${$moduleName}::RewarderKey`,
  fields: {
    dummy_field: bcs.bool(),
  },
});
export const Rewarder = new MoveStruct({
  name: `${$moduleName}::Rewarder`,
  fields: {
    id: object.UID,
...
export const DepositResponseChecker = new MoveStruct({
  name: `${$moduleName}::DepositResponseChecker`,
  fields: {
...
export const WithdrawResponseChecker = new MoveStruct({
  name: `${$moduleName}::WithdrawResponseChecker`,
  fields: {
    /** Set of rewarders that need to be updated */
    rewarder_ids: vec_set.VecSet(bcs.Address),
...
export interface RewardManagerIdsOptions {
  package?: string;
  arguments: RewardManagerIdsArguments | [reg: RawTransactionArgument<string>];
}
...
export function rewardManagerIds(options: RewardManagerIdsOptions) {
  ...
  const argumentsTypes = [`${packageAddress}::saving_incentive::Registry`] satisfies string[];
...
export interface GetRewarderOptions {
  package?: string;
  arguments: GetRewarderArguments | [rewardManager: RawTransactionArgument<string>];
...
export interface RewarderIdsOptions {
  package?: string;
  arguments: RewarderIdsArguments | [rewardManager: RawTransactionArgument<string>];
...
export interface RewarderSourceOptions {
  package?: string;
  arguments: RewarderSourceArguments | [rewarder: RawTransactionArgument<string>];
  typeArguments: [string, string];
}
...
export interface RewarderPoolOptions {
  package?: string;
  arguments: RewarderPoolArguments | [rewarder: RawTransactionArgument<string>];
  typeArguments: [string, string];
}
...
export interface RewarderFlowRateOptions {
  package?: string;
  arguments: RewarderFlowRateArguments | [rewarder: RawTransactionArgument<string>];
  typeArguments: [string, string];
}
...
export interface RewarderTotalStakeOptions {
  package?: string;
  arguments: RewarderTotalStakeArguments | [rewarder: RawTransactionArgument<string>];
  typeArguments: [string, string];
}
...
export interface RewarderStakeTableOptions {
  package?: string;
  arguments: RewarderStakeTableArguments | [rewarder: RawTransactionArgument<string>];
  typeArguments: [string, string];
}
...
export interface RewarderUnitOptions {
  package?: string;
  arguments: RewarderUnitArguments | [rewarder: RawTransactionArgument<string>];
  typeArguments: [string, string];
}
...
export interface RewarderLastUpdateTimestampOptions {
  package?: string;
  arguments: RewarderLastUpdateTimestampArguments | [rewarder: RawTransactionArgument<string>];
  typeArguments: [string, string];
}
...
export interface UnitOfOptions {
  package?: string;
  arguments: UnitOfArguments | [rewarder: RawTransactionArgument<string>, account: RawTransactionArgument<string>];
  typeArguments: [string, string];
}
...
export interface RewardOfOptions {
  package?: string;
  arguments: RewardOfArguments | [rewarder: RawTransactionArgument<string>, account: RawTransactionArgument<string>];
  typeArguments: [string, string];
}
...
export interface AccountExistsOptions {
  ...
  arguments:
    ...
    | [rewarder: RawTransactionArgument<string>, accountAddress: RawTransactionArgument<string>];
  typeArguments: [string, string];
}
...
export interface NewRewardManagerAndShareArguments {
  registry: RawTransactionArgument<string>;
  config: RawTransactionArgument<string>;
  Cap: RawTransactionArgument<string>;
  SavingPool: RawTransactionArgument<string>;
}
export interface NewRewardManagerAndShareOptions {
  package?: string;
  arguments:
    | NewRewardManagerAndShareArguments
    | [
        registry: RawTransactionArgument<string>,
        config: RawTransactionArgument<string>,
        Cap: RawTransactionArgument<string>,
...
export function newRewardManagerAndShare(options: NewRewardManagerAndShareOptions) {
  const packageAddress = options.package ?? '@local-pkg/bucket_saving_incentive';
  const argumentsTypes = [
    `${packageAddress}::saving_incentive::Registry`,
    `${packageAddress}::incentive_config::GlobalConfig`,
  ...
  return (tx: Transaction) =>
    tx.moveCall({
      package: packageAddress,
      module: 'saving_incentive',
      function: 'new_reward_manager_and_share',
      arguments: normalizeMoveArguments(options.arguments, argumentsTypes, parameterNames),
      typeArguments: options.typeArguments,
    });
}
...
export interface UpdateRewardTimestampOptions {
  package?: string;
  arguments:
    | UpdateRewardTimestampArguments
    | [
        rewardManager: RawTransactionArgument<string>,
        config: RawTransactionArgument<string>,
        timestamp: RawTransactionArgument<number | bigint>,
...
export interface SupplyOptions {
  package?: string;
  arguments: SupplyArguments | [rewardManager: RawTransactionArgument<string>, coin: RawTransactionArgument<string>];
  typeArguments: [string, string];
}
...
export interface NewCheckerForDepositActionOptions {
  package?: string;
  arguments:
    | NewCheckerForDepositActionArguments
    | [
        rewardManager: RawTransactionArgument<string>,
        config: RawTransactionArgument<string>,
        depositResponse: RawTransactionArgument<string>,
...
export interface DestroyDepositCheckerOptions {
  package?: string;
  arguments:
    | DestroyDepositCheckerArguments
    | [depositChecker: RawTransactionArgument<string>, config: RawTransactionArgument<string>];
  typeArguments: [string];
}
...
export interface NewCheckerForWithdrawActionOptions {
  package?: string;
  arguments:
    | NewCheckerForWithdrawActionArguments
    | [
        rewardManager: RawTransactionArgument<string>,
        config: RawTransactionArgument<string>,
        withdrawResponse: RawTransactionArgument<string>,
...
export interface DestroyWithdrawCheckerOptions {
  package?: string;
  arguments:
    | DestroyWithdrawCheckerArguments
    | [withdrawChecker: RawTransactionArgument<string>, config: RawTransactionArgument<string>];
  typeArguments: [string];
}
